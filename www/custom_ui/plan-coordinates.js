      ...
      `;
        ...
        document.addEventListener("mousemove", el => {
            ...
            if (el.path[0] && el.path[0].tagName == 'IMG') {
                ...
                content.innerHTML = `left: ${percentX}%<br/>top: ${percentY}%<br />left: ${el.clientX - el.path[0].x}px<br />top: ${el.clientY - el.path[0].y} (${el.path[0].height - el.clientY - el.path[0].y})`;
            }
        });
